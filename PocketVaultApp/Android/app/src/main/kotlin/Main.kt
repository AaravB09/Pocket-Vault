...
internal val logger: SkipLogger = SkipLogger(subsystem = "pocket.vault", category = "PocketVault")

private typealias AppRootView = PocketVaultRootView
private typealias AppDelegate = PocketVaultAppDelegate
